...
Use Radar APIs as  like pickup and delivery tracking, location-triggered notifications, location verification, store locators, address autocomplete, and more. Or, use Radar APIs to , including users, geofences, and events.
...
###### [Authentication level](#authentication-level-1)
...
#### [Forward geocode](/api#forward-geocode)
...
###### [Authentication level](#authentication-level-2)

Publishable

###### [Default rate limit](#default-rate-limit-1)
...
###### [Authentication level](#authentication-level-3)

Publishable

###### [Default rate limit](#default-rate-limit-2)
...
###### [Authentication level](#authentication-level-4)

Publishable

###### [Default rate limit](#default-rate-limit-3)
...
###### [Authentication level](#authentication-level-5)

Publishable

###### [Default rate limit](#default-rate-limit-4)
...
###### [Authentication level](#authentication-level-6)

Secret

###### [Default rate limit](#default-rate-limit-5)
...
#### [Search geofences](#search-geofences)
...
###### [Authentication level](#authentication-level-7)

Publishable

###### [Default rate limit](#default-rate-limit-6)
...
###### [Authentication level](#authentication-level-8)

Publishable

###### [Default rate limit](#default-rate-limit-7)
...
###### [Authentication level](#authentication-level-9)

Publishable

###### [Default rate limit](#default-rate-limit-8)
...
###### [Authentication level](#authentication-level-10)

Publishable

###### [Default rate limit](#default-rate-limit-9)
...
###### [Authentication level](#authentication-level-11)

Publishable

###### [Default rate limit](#default-rate-limit-10)
...
###### [Authentication level](#authentication-level-12)

Publishable

###### [Default rate limit](#default-rate-limit-11)
...
###### [Authentication level](#authentication-level-13)

Publishable

###### [Default rate limit](#default-rate-limit-12)
...
###### [Authentication level](#authentication-level-14)

Publishable

###### [Default rate limit](#default-rate-limit-13)
...
## [Manage your Radar data](#manage-your-radar-data)
...
###### [Default rate limit](#default-rate-limit-14)

10 requests per second

###### [Authentication level](#authentication-level-15)
...
###### [Default rate limit](#default-rate-limit-15)

10 requests per second

###### [Authentication level](#authentication-level-16)
...
###### [Authentication level](#authentication-level-17)
...
###### [Default rate limit](#default-rate-limit-17)
...
###### [Authentication level](#authentication-level-18)
...
#### [Get the route for a trip](#get-the-route-for-a-trip)
...
###### [Default rate limit](#default-rate-limit-18)
...
###### [Authentication level](#authentication-level-19)
...
###### [Default rate limit](#default-rate-limit-19)
...
###### [Authentication level](#authentication-level-20)
...
###### [Default rate limit](#default-rate-limit-20)
...
###### [Authentication level](#authentication-level-21)
...
###### [Default rate limit](#default-rate-limit-21)
...
###### [Authentication level](#authentication-level-22)
...
###### [Default rate limit](#default-rate-limit-22)

10 requests per second

###### [Authentication level](#authentication-level-23)
...
###### [Default rate limit](#default-rate-limit-23)
...
###### [Authentication level](#authentication-level-24)
...
###### [Default rate limit](#default-rate-limit-24)

10 requests per second

###### [Authentication level](#authentication-level-25)
...
#### [Upsert a geofence](#upsert-a-geofence)
...
###### [Default rate limit](#default-rate-limit-25)

10 requests per second

###### [Authentication level](#authentication-level-26)
...
#### [Delete a geofence](#delete-a-geofence)
...
###### [Default rate limit](#default-rate-limit-26)

10 requests per second

###### [Authentication level](#authentication-level-27)
...
#### [Get users in a geofence](#get-users-in-a-geofence)
...
###### [Default rate limit](#default-rate-limit-27)

10 requests per second

###### [Authentication level](#authentication-level-28)
...
#### [Generate an entry or exit event](#generate-an-entry-or-exit-event)
...
#### [Log a conversion](#log-a-conversion)
...
###### [Authentication level](#authentication-level-29)

Publishable

###### [Default rate limit](#default-rate-limit-28)
...
###### [Default rate limit](#default-rate-limit-29)

10 requests per second

###### [Authentication level](#authentication-level-30)
...
###### [Default rate limit](#default-rate-limit-30)

10 requests per second

###### [Authentication level](#authentication-level-31)
...
#### [Create a beacon](#create-a-beacon)
...
###### [Default rate limit](#default-rate-limit-31)

10 requests per second

###### [Authentication level](#authentication-level-32)
...
#### [Upsert a beacon](#upsert-a-beacon)
...
###### [Default rate limit](#default-rate-limit-32)

10 requests per second

###### [Authentication level](#authentication-level-33)
...
#### [Delete a beacon](#delete-a-beacon)
...
###### [Default rate limit](#default-rate-limit-33)

10 requests per second

###### [Authentication level](#authentication-level-34)
...
## [Manage your Radar project settings](#manage-your-radar-project-settings)

### [Places settings](#places-settings)

Places settings represents your current project settings for [Places](/places).

###### [Object fields](#object-fields-5)
...
#### [Get Places settings](#get-places-settings)
...
###### [Default rate limit](#default-rate-limit-34)

10 requests per second

###### [Authentication level](#authentication-level-35)
...
#### [Update Places settings](#update-places-settings)
...
###### [Default rate limit](#default-rate-limit-35)

10 requests per second

###### [Authentication level](#authentication-level-36)

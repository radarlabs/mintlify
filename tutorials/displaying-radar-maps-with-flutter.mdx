...
The SDK has a dependency on [maplibre_gl](https://github.com/maplibre/flutter-maplibre-gl). See the source on GitHub [here](https://github.com/radarlabs/flutter-radar). Or, see the `flutter_radar` package on [pub.dev](http://pub.dev) [here](https://pub.dev/packages/flutter_radar).
...
Optionally, add assets for a marker. You can download assets <a href="https://static.radar.com/downloads/radar-map-assets-v1.zip" download>here</a>. Once downloaded, add marker assets to `images/` dir.

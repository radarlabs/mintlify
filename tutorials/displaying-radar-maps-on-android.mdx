...
Import assets for the Radar logo and optionally for a marker. You can download assets <a href="https://static.radar.com/downloads/radar-map-assets-v1.zip" download>here</a>.

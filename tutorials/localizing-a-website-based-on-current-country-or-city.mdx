...
<iframe className="youtube-clip" src="https://www.youtube.com/watch?v=yIjPk4nddBA" title="Localizing a website based on country or city" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />

...
<Steps>
  ...
  <Step title="Start a trip when the professional begins traveling">
    ...
    **Tracking frequency**
    ...
    - **On-trip tracking options**: increase tracking frequency while a professional is actively on a trip using a modified version of the`CONTINUOUS` preset, with `desiredStoppedUpdateInterval: 60` and `desiredMovingUpdateInterval: 60`.

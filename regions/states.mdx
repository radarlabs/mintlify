...
[Regions](/geofencing/regions) supports state detection in the US and Canada only. Each state has a `name` and a 2-letter `code` unique to the residing `country`.
...
[Edit this page](https://github.com/radarlabs/docs/edit/main/docs/regions/states.mdx)
...
[Regions](https://docs.radar.com/regions) supports DMA (designated market area) detection in the US only. Each DMA has a `name` and a unique `code`. Learn more about [DMAs](https://en.wikipedia.org/wiki/Media_market).
...
[Edit this page](https://github.com/radarlabs/docs/edit/main/docs/regions/dmas.mdx)
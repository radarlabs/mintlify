...
Then, on the Radar [Integrations page](https://dashboard.radar.com/integrations) under _Amplitude_, set _Enabled_ to _Yes_ and paste your API key. Note that you can set separate API keys for the _Test_ and _Live_ environments.

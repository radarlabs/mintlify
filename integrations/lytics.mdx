...
Then, on the Radar [Integrations page](https://dashboard.radar.com/integrations) under _Lytics_, set _Enabled_ to _Yes_, paste your API token. Note that you can set separate API tokens and stream names for the _Test_ and _Live_ environments.

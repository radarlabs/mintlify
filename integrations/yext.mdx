...
On the Radar [Integrations page](https://dashboard.radar.com/integrations) under _Yext_, set _Enabled_ to _Yes_ and optionally configure any additional settings.
...
You can choose to override certain defaults with additional configuration settings for the [geofences](/geofencing/geofences) synced from Yext.
...
Once configured, click _Connect & Sync_ and you will be redirected to Yext, where you can authorize Radar. Then, you will be redirected back to the Radar [Integrations page](https://dashboard.radar.com/integrations) with an indication of whether the authorization succeeded or failed. If the authorization succeeded, your Yext locations will immediately begin syncing to Radar [geofences](/geofencing/geofences).

...
Then, on the Radar [Integrations page](https://dashboard.radar.com/integrations) under _Branch_, set _Enabled_ to _Yes_ and paste your key. Note that you can set separate keys for the _Test_ and _Live_ environments.

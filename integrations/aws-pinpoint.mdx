...
Then, on the Radar [Integrations page](https://dashboard.radar.com/integrations) under _AWS Pinpoint_, set _Enabled_ to _Yes_ and paste your AWS access key, your AWS secret key, and your Pinpoint Project ID. You can set separate access keys and project IDs for each of your Radar _Test_ and _Live_ environments. Finally, select your AWS region.

...
Then, on the Radar [Integrations page](https://dashboard.radar.com/integrations#cordial) under _Cordial_, set _Enabled_ to _Yes_ and paste your API key. Note that you can set separate API keys and app identifiers for the _Test_ and _Live_ environments. Then, paste your async API endpoint, like `https://integrations-ingest-svc.usw2.cordial.com`. Finally, enter the secondary key.

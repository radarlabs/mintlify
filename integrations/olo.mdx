...
Finally, on the Radar [Geofences page](https://radar.com/dashboard/geofences), [import geofences](/geofencing/geofences#csv-import) for your restaurants. Use the tag from the Olo integration configuration for the geofence `tag` attribute.

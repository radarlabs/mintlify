...
Additionally, you can restrict which websites can use your publishable API keys. You can add or modify available domains on the [settings](https://dashboard.radar.com/settings#website-restrictions) page. Multiple domains are supported with the selectable input field.

...
### [How should I test Radar battery drain?](#how-should-i-test-radar-battery-drain)
...
### [Can I test Radar side-by-side with another location SDK?](#can-i-test-radar-side-by-side-with-another-location-sdk)
...
### [Is Radar still able to track location in the background if the app is killed?](#is-radar-still-able-to-track-location-in-the-background-if-the-app-is-killed)
...
### [If a user backgrounds my app, do I need to request background location permissions to access location?](#if-a-user-backgrounds-my-app-do-i-need-to-request-background-location-permissions-to-access-location)
...
### [What are the different event listeners and how should I use them?](#what-are-the-different-event-listeners-and-how-should-i-use-them)
...
### [What is the latency of Radar APIs?](#what-is-the-latency-of-radar-apis)
...
### [How often are usage statistics recalculated?](#how-often-are-usage-statistics-recalculated)
...
### [What data does the Radar SDK collect?](#what-data-does-the-radar-sdk-collect)
...
### [What are privacy best practices for Radar?](#what-are-privacy-best-practices-for-radar)
...
### [What are location permission prompt best practices?](#what-are-location-permission-prompt-best-practices)
...
### [What is Radar's data retention policy?](#what-is-radars-data-retention-policy)
...
### [Is Radar CCPA-compliant and GDPR-compliant?](#is-radar-ccpa-compliant-and-gdpr-compliant)
...
### [How do Radar account roles work?](#how-do-radar-account-roles-work)
...
### [How do data access controls work?](#how-do-data-access-controls-work)
...
- **Data access**: Access to specific data and pages across projects in an organization
  - _User locations_: Access to data on the user details page (map and location information) and access to the user locations page
  - _Trip locations_: Access to data on the trip details page (map and location information) and access to the [trip tracking dashboard](/trip-tracking#in-the-radar-trip-tracking-dashboard)
...
### [Does Radar have a bug bounty or responsible disclosure program?](#does-radar-have-a-bug-bounty-or-responsible-disclosure-program)

Yes. For more information, see the [Vulnerability Disclosure Policy](/vulnerability-disclosure-policy).

### [What are security best practices for Radar?](#what-are-security-best-practices-for-radar)
...
#### [Mobile Restrictions](#mobile-restrictions)
...
### [Does Radar support audit logs?](#does-radar-support-audit-logs)
...
### [How do I set up single sign-on (SSO) in Radar?](#how-do-i-set-up-single-sign-on-sso-in-radar)
...
### [Is Radar SOC 2 type II-certified?](#is-radar-soc-2-type-ii-certified)
...
### [Is the Radar SDK secure?](#is-the-radar-sdk-secure)
...
### [How do I get statistics for location permissions?](#how-do-i-get-statistics-for-location-permissions)

Statistics for location permissions are available for customers who have installed SDK 3.1 or later.

### [What do the states in the location permissions graph represent?](#what-do-the-states-in-the-location-permissions-graph-represent)
...
### [What is a tracked user?](#what-is-a-tracked-user)

A tracked user is a unique user that sends one or more location events to Radar in a given time period.

### [What is a unique user? When does Radar create a new user record?](#what-is-a-unique-user-when-does-radar-create-a-new-user-record)
...
- `userId`: set by calling `Radar.setUserId()`, also called _External ID_ in the dashboard

Each user record is also assigned a unique `_id`, also called _Radar ID_ in the dashboard.
...
### [Why are counts of active users different from counts of tracked users?](#why-are-counts-of-active-users-different-from-counts-of-tracked-users)

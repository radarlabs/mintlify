...
This is the documentation for the Flutter package. Before integrating, read the [native SDK documentation](https://docs.radar.com/sdk) to familiarize yourself with the platform.
...
The Flutter package also exposes APIs for geocoding, search, and distance.

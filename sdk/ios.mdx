...
As of version 3.25.0, in order to use Radar Fraud, you will also need to add the `RadarSDKFraud` [Swift Package](https://github.com/radarlabs/radar-sdk-ios-fraud-spm) or [CocoaPod](https://cocoapods.org/pods/RadarSDK) to your target. Refer to [**Fraud**](/geofencing/fraud) for more information.

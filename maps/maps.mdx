...
<iframe src="https://maps-demo.radar.com/map" width="100%" height="500" frameBorder="0" allowFullScreen />

You can also check out the [maps explorer](https://dashboard.radar.com/maps/maps-explorer/maps) in the dashboard, or check out a full-page [maps demo](https://radar.com/demo/maps) and [store locator demo](https://radar.com/demo/locator).
...
Note: The maps plugin has a peer dependency on [maplibre-gl](https://github.com/maplibre/maplibre-gl-js).
...
The maps plugin CDN bundle auto-registers with the core SDK when loaded.
...
```javascript
const feature = map.addPolyline('iyeulAveaclCuVfw...', {
...
<iframe src="https://maps-demo.radar.com/fit-bounds-map" width="100%" height="500" frameBorder="0" allowFullScreen />
...
<iframe src="https://maps-demo.radar.com/custom-image-marker-map" width="100%" height="500" frameBorder="0" allowFullScreen />
...
<iframe src="https://maps-demo.radar.com/custom-popup-map" width="100%" height="500" frameBorder="0" allowFullScreen />
...
<iframe src="https://maps-demo.radar.com/route-map" width="100%" height="500" frameBorder="0" allowFullScreen />
...
<iframe src="https://maps-demo.radar.com/polygon-map" width="100%" height="500" frameBorder="0" allowFullScreen />
...
<iframe src="https://maps-demo.radar.com/globe-map" width="100%" height="500" frameBorder="0" allowFullScreen />
...
<iframe src="https://maps-demo.radar.com/custom-language-map" width="100%" height="500" frameBorder="0" allowFullScreen />

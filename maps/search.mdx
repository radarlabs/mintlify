...
<img
  src="/images/illustrations/search-illustration.png"
...
This endpoint is best for partial addresses. For complete addresses, call the [forward geocoding API](/maps/geocoding#forward-geocoding) instead.
...
Use the places search API to search for places near a location, filtered by [chain](/geofencing/places#chains) (e.g., `mcdonalds`) or [category](/geofencing/places#categories) (e.g., `airport`).

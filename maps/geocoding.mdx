...
<img
  src="/images/illustrations/geocode-illustration.png"
  alt="Geocode illustration"
  style={{ width:"40%" }}
/>
...
Then, call one of the geocoding APIs below, either [directly](/api) or [using the SDK](/sdk/sdk).
...
This endpoint is best for complete addresses. For partial addresses, call the [autocomplete API](/maps/search#address-autocomplete) instead.

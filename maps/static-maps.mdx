...
![Static Map Pn](/images/maps/static-map.png)
...
![Static Map Two Pins Pn](/images/maps/static-map-two-pins.png)
...
![Static Map Two Pins Different Pn](/images/maps/static-map-two-pins-different.png)
...
![Static Map Paths Pn](/images/maps/static-map-paths.png)
...
![Static Map Embed Pn](/images/maps/static-map-embed.png)
...
![Static Map Autofit Pn](/images/maps/static-map-autofit.png)
...
![Static Map Custom Marker Pn](/images/maps/static-map-custom-marker.png)

### Rendering a route

Radar [Routing API](/api#routing) responses include the shape of the route in either the polyline or LineString format. Both of these formats are supported for rendering a path, which can be used to plot the route in a static image.
...
![Static Map Routing Pn](/images/maps/static-map-routing.png)
...
| ------------------ | ------------------ |
| ![Static Map 1x scale](/images/maps/static-map-high-res-1x.png)     | ![Static Map 2x scale](/images/maps/static-map-high-res-2x.png)      |

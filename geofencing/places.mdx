...
Navigate to the [Geofences page](https://radar.com/dashboard/geofences) and select _Import_. If [Places](/geofencing/places) are enabled for your project, toggle _Enable place matching_ on.

...
<img
  src="/images/illustrations/beacons-illustration.png"
  alt="Beacon illustration"
  style={{ width:"40%" }}
/>
...
To create a beacon via the dashboard, go to the [Beacons page](https://dashboard.radar.com/geofencing/beacons) and click the _New_ button. Optionally search for an address or place, then enter a type, tag, external ID, UUID, major, minor, and optional metadata. Click _Create_ to create the beacon.

### CSV import

To import beacons via CSV import, go to the [Beacons page](https://dashboard.radar.com/geofencing/beacons) and click the _Import_ button. Then, select a CSV to upload.

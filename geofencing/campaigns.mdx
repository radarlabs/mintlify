...
To use campaigns with [Geofences](/geofencing/geofences), start by [creating geofences](/geofencing/geofences#create-geofences) through the dashboard, a CSV import, or the API.

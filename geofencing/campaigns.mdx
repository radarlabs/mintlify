...
Both client-side geofence notifications and event-based notifications include analytics on notification delivery, allowing you to track when notifications are delivered to users' devices. Note that for client-side notifications, iOS SDK versions earlier than [v3.29.0](https://github.com/radarlabs/radar-sdk-ios/releases/tag/3.29.0) have less accurate delivery tracking.

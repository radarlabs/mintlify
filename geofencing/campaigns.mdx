...
**Place chains -** allow you to target specific chains like Starbucks or Target. For event based campaigns, you can target users based on their device type (iOS, Android, or both). 

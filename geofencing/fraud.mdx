...
As an alternative to publishable API keys, you can create temporary auth tokens. Auth tokens have a `ttl` and optional constraints (e.g., `product`, `expectedCountryCode`, `expectedStateCode`, and/or `userId`).

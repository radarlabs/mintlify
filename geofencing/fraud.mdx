...
Radar lets you segment products within your platform, where each product can have its own fraud settings, including allowed jurisdictions, configurable directly in your dashboard.

To add a new product, go to your dashboard and click **“\+ Add Product”** under your default Fraud settings: https://dashboard.radar.com/settings#fraud-settings.

Once a product is added, you can switch between products in your code using:

```swift
Radar.setProduct("sportsbook" | "casino" | ...)
```

This ensures that the appropriate fraud settings are applied automatically for each product type.

For more advanced product management and configuration, contact your Customer Success Manager to discuss best practices for your implementation.Manual location checks

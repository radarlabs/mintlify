...
To troubleshoot a failed geolocation check, go to the [Fraud page](https://dashboard.radar.com/geofencing/). Use the _Filters_ button to filter down to specific user IDs, IP addresses, or jurisdictions, and use the _date filters_ to filter down to specific dates or times.

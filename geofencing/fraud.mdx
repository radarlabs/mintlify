...
On the [Settings page](https://dashboard.radar.com/settings), under *Auth tokens*, add a new public key. Paste the full contents of your public key PEM file, including the `BEGIN` and `END` lines. Copy the *Key ID*.

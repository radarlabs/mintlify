...
For [multi-leg trips](#multi-leg-trips), the response includes additional fields:
...
```json
{
  "trip": {
    ...
    "mode": "car",
    "currentLegId": "6f4e60591d3c8e006d92g6ea",
    "legs": [
      {
        "_id": "6f4e60591d3c8e006d92g6ea",
        "status": "started",
...
<Info>
  Multi-leg trips requires additional configuration. Contact your customer success manager or reach out to us at [radar.com/support](https://radar.com/support) to enable this feature.
</Info>
